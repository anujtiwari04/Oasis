...
export const Route = createFileRoute("/shareholding-pattern-mar-2026")({
  component: Mar2026ShareholdingPage,
});

function Mar2026ShareholdingPage() {
  return (
                ...
                <table className="w-full max-w-2xl border-collapse text-sm text-left border border-slate-300" border={1}>
                  <tbody>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-4 py-2">31-03-2026</td>
                    </tr>
                    <tr className="border-b border-slate-300">
            ...
            <section className="space-y-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-sm text-left border border-slate-300" border={1}>
                  ...
                  <tbody>
                    <tr className="border-b border-slate-300">
                      <td className="px-4 py-2 border-r border-slate-300 text-center font-medium">1</td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-4 py-2 border-r border-slate-300 text-center font-medium">2</td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-4 py-2 border-r border-slate-300 text-center font-medium">3</td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-4 py-2 border-r border-slate-300 text-center font-medium">4</td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-4 py-2 border-r border-slate-300 text-center font-medium">5</td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-4 py-2 border-r border-slate-300 text-center font-medium">6</td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-4 py-2 border-r border-slate-300 text-center font-medium">7</td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-4 py-2 border-r border-slate-300 text-center font-medium">8</td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-4 py-2 border-r border-slate-300 text-center font-medium">9</td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-4 py-2 border-r border-slate-300 text-center font-medium">10</td>
                    ...
                    <tr>
                      <td className="px-4 py-2 border-r border-slate-300 text-center font-medium">11</td>
                ...
                <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1000px]" border={1}>
                  ...
                  <tbody>
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-right">13,183,745</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">13,183,745</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">71.26</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">13,183,745</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">13,183,745</td>
                      <td className="px-2 py-2 text-center">71.26</td>
                    </tr>
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-center">1,926</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">5,316,255</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">5,316,255</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">28.74</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">5,316,255</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">5,316,255</td>
                      <td className="px-2 py-2 text-center">28.74</td>
                    </tr>
                    <tr className="border-b border-slate-300">
                    ...
                    <tr className="bg-slate-100 font-bold">
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">Total</td>
                      <td className="px-2 py-2 border-r border-slate-300 font-bold">Total</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">1,931</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">18,500,000</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400 font-bold"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400 font-bold"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">18,500,000</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">100</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">18,500,000</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400 font-bold"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">18,500,000</td>
                ...
                <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1100px]" border={1}>
                  ...
                  <tbody>
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 font-semibold">Promoter & Promoter Group</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-semibold">71.26</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 font-semibold">Public</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-semibold">28.74</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">4,690,645</td>
                    ...
                    <tr className="bg-slate-100 font-bold">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400 font-bold"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400 font-bold"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">17,874,390</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">0</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">0</td>
                ...
                <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1000px]" border={1}>
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-center">1</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">87,655</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">87,655</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">0.47</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">87,655</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">87,655</td>
                      <td className="px-2 py-2 text-center">0.47</td>
                    </tr>
                    ...
                    <tr className="font-semibold border-b border-slate-300">
                      ...
                      <td colSpan={11} className="px-2 py-2 text-slate-500">Foreign - [All fields blank]</td>
                    </tr>
                    <tr className="bg-slate-100 font-bold border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300 text-center"></td>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-center">1,853</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">4,069,416</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">4,069,416</td>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-right">67,653</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">67,653</td>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-right">411,451</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">411,451</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">2.22</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">411,451</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">411,451</td>
                      <td className="px-2 py-2 text-center">2.22</td>
                    </tr>
                    <tr className="border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300 text-center">(m)</td>
                      <td className="px-2 py-2 border-r border-slate-300 pl-4">Any Other (specify)</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">50</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">321,855</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">321,855</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">1.74</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">321,855</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">321,855</td>
                      <td className="px-2 py-2 text-center">1.74</td>
                    </tr>
                    <tr className="bg-slate-50 font-semibold border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300 text-center"></td>
                ...
                <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1100px]" border={1}>
                  ...
                  <tbody>
                    <tr className="border-b border-slate-300 font-semibold">
                      <td className="px-2 py-2 border-r border-slate-300" colSpan={2}>(a) [Individuals/HUF]</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">70.79</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300 pl-4" colSpan={2}>(d) [Any Other]</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">0.47</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                    ...
                    <tr className="bg-slate-50 font-semibold border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300" colSpan={2}>Sub-Total (A)(1)</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">71.26</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                    ...
                    <tr className="bg-slate-100 font-bold border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300" colSpan={2}>Total Promoter Group (A)</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">71.26</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300" colSpan={2}>(g) [Public Individual &lt;= 2L]</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">22</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">3,449,806</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">0</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">0</td>
                      <td className="px-2 py-2 text-center">0</td>
                    </tr>
                    <tr className="border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300" colSpan={2}>(h) [Public Individual &gt; 2L]</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">2.41</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300" colSpan={2}>(i) [NRIs]</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">0.37</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                    ...
                    <tr className="border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300" colSpan={2}>(l) [Bodies Corporate]</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">2.22</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">410,451</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">0</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">0</td>
                      <td className="px-2 py-2 text-center">0</td>
                    </tr>
                    <tr className="border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300" colSpan={2}>(m) [Any Other]</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">1.74</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">316,855</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">0</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">0</td>
                      <td className="px-2 py-2 text-center">0</td>
                    </tr>
                    <tr className="bg-slate-50 font-semibold border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300" colSpan={2}>Sub-Total (B)(4)</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">28.74</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                    ...
                    <tr className="bg-slate-100 font-bold border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300" colSpan={2}>Total Public Shareholding (B)</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">28.74</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400"></td>
                    ...
                    <tr className="bg-slate-100 font-bold">
                      <td className="px-2 py-2 border-r border-slate-300" colSpan={2}>Total (A+B+C)</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">100</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400 font-bold"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400 font-bold"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400 font-bold"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400 font-bold"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">17,874,390</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-bold"></td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-bold"></td>
                      <td className="px-2 py-2 text-center font-bold"></td>
                    </tr>
                  </tbody>
                </table>
              </div>
                  ...
                  <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1000px]" border={1}>
                    <thead className="bg-slate-50 font-bold">
                      <tr className="border-b border-slate-300">
                        ...
                        <th className="px-2 py-2 border-r border-slate-300">Name of Shareholder</th>
                        <th className="px-2 py-2 border-r border-slate-300 w-24">PAN</th>
                        <th className="px-2 py-2 border-r border-slate-300 w-36">Details</th>
                        <th className="px-2 py-2 border-r border-slate-300 w-24 text-right">Fully Paid Shares (IV)</th>
                        <th className="px-2 py-2 border-r border-slate-300 w-24 text-right">Total Shares (VII)</th>
                        <th className="px-2 py-2 border-r border-slate-300 w-20 text-center">Shareholding % (VIII)</th>
                        <th className="px-2 py-2 border-r border-slate-300 w-24 text-right">Voting Class X</th>
                    ...
                    <tbody>
                      <tr className="border-b border-slate-300">
                        ...
                        <td className="px-2 py-2 border-r border-slate-300">No. of shareholders: 1</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">87,655</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">87,655</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">0.47</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">87,655</td>
                      ...
                      <tr className="border-b border-slate-300">
                        ...
                        <td className="px-2 py-2 border-r border-slate-300">No. of shareholders: 0</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">0</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">0</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">0</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">0</td>
                  ...
                  <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1000px]" border={1}>
                    ...
                    <tbody>
                      ...
                      <tr className="bg-slate-100 font-bold">
                        <td colSpan={2} className="px-2 py-2 border-r border-slate-300 text-center">Total</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-slate-400"></td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">279,670</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">279,670</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">1.51</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">279,670</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">279,670</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">1.51</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">279,670</td>
                  ...
                  <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1000px]" border={1}>
                    ...
                    <tbody>
                      ...
                      <tr className="bg-slate-100 font-bold">
                        <td colSpan={2} className="px-2 py-2 border-r border-slate-300 text-center">Total</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-slate-400"></td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">445,880</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">445,880</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">2.41</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">445,880</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">445,880</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">2.41</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">445,880</td>
                  ...
                  <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1000px]" border={1}>
                    ...
                    <tbody>
                      <tr className="border-b border-slate-300">
                        ...
                        <td className="px-2 py-2 border-r border-slate-300 text-center">3</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">7,565</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">7,565</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">0.04</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">7,565</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">7,565</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">0.04</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">7,565</td>
                      ...
                      <tr className="border-b border-slate-300">
                        ...
                        <td className="px-2 py-2 border-r border-slate-300 text-right">308,170</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">308,170</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">1.67</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">308,170</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">308,170</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">1.67</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">303,170</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">0</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">0</td>
                        <td className="px-2 py-2 text-center">0</td>
                      </tr>
                      <tr className="border-b border-slate-300">
                        <td className="px-2 py-2 border-r border-slate-300 text-center">3</td>
                        <td className="px-2 py-2 border-r border-slate-300">LLP</td>
                        <td className="px-2 py-2 border-r border-slate-300">Category</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">2</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">6,120</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">6,120</td>
                      ...
                      <tr className="bg-slate-100 font-bold">
                        <td colSpan={3} className="px-2 py-2 border-r border-slate-300 text-center">Total</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">50</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">321,855</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">321,855</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">1.74</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">321,855</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">321,855</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">1.74</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-bold">316,855</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">0</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center font-bold">0</td>
                        <td className="px-2 py-2 text-center font-bold">0</td>
                      </tr>
