...
export const Route = createFileRoute("/shareholding-pattern-dec-2016")({
  component: Dec2016ShareholdingPage,
});

function Dec2016ShareholdingPage() {
  return (
        ...
        <main className="py-12 sm:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
                ...
                <table className="w-full max-w-2xl border-collapse text-sm text-left border border-slate-300" border={1}>
                  <tbody>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-4 py-2">31-12-2016</td>
                    </tr>
                    <tr className="border-b border-slate-300">
                ...
                <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1000px]" border={1}>
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-center">808</td>
                    ...
                    <tr className="bg-slate-100 border-b border-slate-300 font-bold">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-center">819</td>
                ...
                <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1000px]" border={1}>
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-right">344,209</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">344,209</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">18.61</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">344,209</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">344,209</td>
                      <td className="px-2 py-2 text-center">18.61</td>
                    </tr>
                    <tr className="border-b border-slate-300">
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-center">51</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">240,812</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">240,812</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center">13.02</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">240,812</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-right">240,812</td>
                      <td className="px-2 py-2 text-center">13.02</td>
                    </tr>
                    <tr className="bg-slate-50 font-semibold border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300 text-center"></td>
                ...
                <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1000px]" border={1}>
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-semibold">18.61</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 text-right font-semibold">243,857</td>
                    </tr>
                    <tr className="border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300 text-center">(a(ii))</td>
                      <td className="px-2 py-2 border-r border-slate-300">[Public Individual &gt; 2L]</td>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center font-semibold">13.02</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 border-r border-slate-300 text-center text-slate-400">-</td>
                      <td className="px-2 py-2 text-right font-semibold">240,212</td>
                    </tr>
                    <tr className="bg-slate-50 font-semibold border-b border-slate-300">
                      <td className="px-2 py-2 border-r border-slate-300 text-center"></td>
            ...
            <section className="space-y-8">
              ...
              <div className="space-y-3">
                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wide">
                  Table 7B: Individuals/Hindu undivided Family (Promoters 8 to 11 & Total Column)
                </h3>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[900px]" border={1}>
                    <thead className="bg-slate-50 font-bold text-center">
                  ...
                  <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[900px]" border={1}>
                    ...
                    <tbody>
                      ...
                      <tr className="border-b border-slate-300">
                        ...
                        <td className="px-2 py-2 border-r border-slate-300 text-right font-mono">AELPR3226C</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">35,000</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">35,000</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">1.89</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">35,000</td>
                  ...
                  <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1000px]" border={1}>
                    ...
                    <tbody>
                      <tr className="border-b border-slate-300">
                        ...
                        <td className="px-2 py-2 border-r border-slate-300 text-right">200,928</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">200,928</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">10.86</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">200,928</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">10.86</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">10.86</td>
                        <td className="px-2 py-2 text-right">200,828</td>
                      </tr>
                      <tr className="border-b border-slate-300">
                        <td className="px-2 py-2 border-r border-slate-300 text-center">2</td>
                        <td className="px-2 py-2 border-r border-slate-300">Bodies Corporate</td>
                      ...
                      <tr className="border-b border-slate-300">
                        ...
                        <td className="px-2 py-2 border-r border-slate-300 text-center">1</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">74,177</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">74,177</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">4.01</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">74,177</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">4.01</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">4.01</td>
                        <td className="px-2 py-2 text-right">74,177</td>
                      </tr>
                      <tr className="border-b border-slate-300">
                        <td className="px-2 py-2 border-r border-slate-300 text-center">5</td>
                      ...
                      <tr>
                        ...
                        <td className="px-2 py-2 border-r border-slate-300 text-slate-400">-</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-slate-400 text-center">-</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">20</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">37,652</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">37,652</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">2.04</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">37,652</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">2.04</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">2.04</td>
                        <td className="px-2 py-2 text-right">37,152</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="space-y-3">
                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wide">
                  Table 7E: Any Other (Specify) Subcategories (Columns 8 to 10 & Total Column)
                </h3>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse text-xs text-left border border-slate-300 min-w-[1000px]" border={1}>
                    <thead className="bg-slate-50 font-bold text-center">
                    ...
                    <tbody>
                      <tr className="border-b border-slate-300">
                        ...
                        <td className="px-2 py-2 border-r border-slate-300">HUF</td>
                        <td className="px-2 py-2 border-r border-slate-300">More than 1 percentage</td>
                        <td className="px-2 py-2 border-r border-slate-300 font-semibold">SANJEEV GORWARA</td>
                      ...
                      <tr className="bg-slate-100 font-bold border-b border-slate-300">
                        ...
                        <td className="px-2 py-2 border-r border-slate-300 text-right">240,812</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">240,812</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">13.03</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-right">240,812</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">13.03</td>
                        <td className="px-2 py-2 border-r border-slate-300 text-center">13.03</td>
                        <td className="px-2 py-2 text-right">240,212</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
