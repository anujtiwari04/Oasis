...
// Asset imports
import igDec2024 from "@/assets/Investor Grievance Reports/REGULATION 13 (3)_DECEEMBER 2024.pdf";
import igComplaint62 from "@/assets/Investor Grievance Reports/Reg 13(3) Statement Of Investor Complaint 62.pdf";
...
const reports = [
  {
    title: "Statement of Investor Complaints (Regulation 13(3)) - December 2024",
    href: igDec2024,
    filename: "REGULATION 13 (3)_DECEEMBER 2024.pdf",
  },
  {
    title: "Statement of Investor Complaints (Regulation 13(3))",
    href: igComplaint62,
    filename: "Reg 13(3) Statement Of Investor Complaint 62.pdf",
  },
];
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="mb-8">
              ...
              <p className="mt-2 text-slate-600 text-sm sm:text-base">
                Access and download Investor Grievance Reports of Oasis Securities Limited.
              </p>
            </div>
